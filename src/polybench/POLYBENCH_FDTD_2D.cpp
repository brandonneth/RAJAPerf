...
void POLYBENCH_FDTD_2D::runKernel(VariantID vid)
{
  ...
  auto poly_fdtd2d_lam1 = [&](auto j) {
                            POLYBENCH_FDTD_2D_BODY1_RAJA;
                          };
  auto poly_fdtd2d_lam2 = [=](auto i, auto j) {
                            POLYBENCH_FDTD_2D_BODY2_RAJA;
                          };
  auto poly_fdtd2d_lam3 = [=](auto i, auto j) {
                            POLYBENCH_FDTD_2D_BODY3_RAJA;
                          };
  auto poly_fdtd2d_lam4 = [=](auto i, auto j) {
  ...
  switch ( vid ) {
    ...
    case LoopChain : {
      ...
      auto knl1 = RAJA::make_forall<EXEC_POL1>(RAJA::RangeSegment(0,ny), poly_fdtd2d_lam1);
      
      auto knl2 = RAJA::make_kernel<EXEC_POL234>(
        RAJA::make_tuple(RAJA::RangeSegment(1,nx), RAJA::RangeSegment(0,ny)),
        poly_fdtd2d_lam2);
      auto knl3 = RAJA::make_kernel<EXEC_POL234>(
        RAJA::make_tuple(RAJA::RangeSegment(0,nx), RAJA::RangeSegment(1,ny)),
        poly_fdtd2d_lam3);
      auto knl4 = RAJA::make_kernel<EXEC_POL234>(
        RAJA::make_tuple(RAJA::RangeSegment(0,nx-1), RAJA::RangeSegment(0,ny-1)),
        poly_fdtd2d_lam4);

      auto fused_knl = RAJA::fuse(knl2,knl3);
      startTimer();
      for (RepIndex_type irep = 0; irep < run_reps; ++irep) {
