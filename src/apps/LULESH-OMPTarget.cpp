...
#define LULESH_DATA_SETUP_OMP_TARGET \
...
#define LULESH_DATA_TEARDOWN_OMP_TARGET \
...
void LULESH::runOpenMPTargetVariant(VariantID vid)
{
  ...
  if ( vid == Base_OpenMPTarget ) {
    ...
    LULESH_DATA_TEARDOWN_OMP_TARGET;
    ...
    LULESH_DATA_TEARDOWN_OMP_TARGET;
     ...
     std::cout << "\n  LULESH : Unknown OMP Target variant id = " << vid << std::endl;
  }
}
