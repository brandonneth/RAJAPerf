...
#define LULESH_DATA_TEARDOWN_CUDA \
...
void LULESH::runCudaVariant(VariantID vid)
{
...
// was not supported until CUDA 9.x
    ...
    LULESH_DATA_TEARDOWN_CUDA;
     ...
     std::cout << "\n  LULESH : Unknown Cuda variant id = " << vid << std::endl;
  }
}
